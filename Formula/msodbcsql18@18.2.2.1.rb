class Msodbcsql18AT18221 < Formula
  desc "ODBC Driver for Microsoft(R) SQL Server(R)"
  homepage "https://msdn.microsoft.com/en-us/library/mt654048(v=sql.1).aspx"
  url Hardware::CPU.arch == :arm64 ? "https://download.microsoft.com/download/0/9/7/0976a30f-1710-4754-9445-bead058dd0c8/msodbcsql18-18.2.2.1-arm64.tar.gz" :
                                     "https://download.microsoft.com/download/0/9/7/0976a30f-1710-4754-9445-bead058dd0c8/msodbcsql18-18.2.2.1-amd64.tar.gz"
  version "18.2.2.1"
  sha256 Hardware::CPU.arch == :arm64 ? "7f5601b68a714721ac083b5235f3871262195f4ee5952e67686e27a3c90fa339" :
                                        "43155effe8f403135866763b61e0cdebf405f0b3664bfb66ead963edb8d49a21"
