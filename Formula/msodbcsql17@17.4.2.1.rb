class Msodbcsql17AT17421 < Formula
  desc "ODBC Driver for Microsoft(R) SQL Server(R)"
  homepage "https://msdn.microsoft.com/en-us/library/mt654048(v=sql.1).aspx"
  url "https://download.microsoft.com/download/1/9/A/19AF548A-6DD3-4B48-88DC-724E9ABCEB9A/msodbcsql-17.4.2.1.tar.gz"
  version "17.4.2.1"
  sha256 "b3489aabedfd870c8fa7d750f4d3230c96f28c5fa91182089b7645b57f607138"
