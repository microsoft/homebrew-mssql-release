class Msodbcsql18AT18311 < Formula
  desc "ODBC Driver for Microsoft(R) SQL Server(R)"
  homepage "https://msdn.microsoft.com/en-us/library/mt654048(v=sql.1).aspx"
  url Hardware::CPU.arch == :arm64 ? "https://download.microsoft.com/download/d/4/7/d47963dd-a254-4d67-a92a-d3d5466df7e4/msodbcsql18-18.3.1.1-arm64.tar.gz" :
                                     "https://download.microsoft.com/download/d/4/7/d47963dd-a254-4d67-a92a-d3d5466df7e4/msodbcsql18-18.3.1.1-amd64.tar.gz"
  version "18.3.1.1"
  sha256 Hardware::CPU.arch == :arm64 ? "01e1d2df29f2a3ea9ccb064fce33462e92c9d72f10b6a759b2a6410670794b66" :
                                        "f23542182eebb521032f7a025efe46909fc1f315f1f5c0974005d400a643ad90"
