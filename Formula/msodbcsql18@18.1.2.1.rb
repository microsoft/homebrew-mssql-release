class Msodbcsql18AT18121 < Formula
  desc "ODBC Driver for Microsoft(R) SQL Server(R)"
  homepage "https://msdn.microsoft.com/en-us/library/mt654048(v=sql.1).aspx"
  url Hardware::CPU.arch == :arm64 ? "https://download.microsoft.com/download/6/4/0/64006503-51e3-44f0-a6cd-a9b757d0d61b/msodbcsql18-18.1.2.1-arm64.tar.gz" :
                                     "https://download.microsoft.com/download/6/4/0/64006503-51e3-44f0-a6cd-a9b757d0d61b/msodbcsql18-18.1.2.1-amd64.tar.gz"
  version "18.1.2.1"
  sha256 Hardware::CPU.arch == :arm64 ? "97cfc9cb3e1922669acd8ade20471ce57eaa0e81edd98bf21afad2cd70edcd5d" :
                                        "b81f3cf5abd4c339ea56e36564e1e40d02c13fbf62aa7091ba4f321d47aea910"
